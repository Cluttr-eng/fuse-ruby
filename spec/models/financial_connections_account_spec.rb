...
# Unit tests for FuseClient::FinancialConnectionsAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FuseClient::FinancialConnectionsAccount do
  let(:instance) { FuseClient::FinancialConnectionsAccount.new }
  ...
  describe 'test an instance of FinancialConnectionsAccount' do
    it 'should create an instance of FinancialConnectionsAccount' do
      ...
      #expect(instance).to be_instance_of(FuseClient::FinancialConnectionsAccount)
    end
  end
