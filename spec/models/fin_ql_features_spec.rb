...
# Unit tests for FuseClient::FinQLFeatures
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FuseClient::FinQLFeatures do
  let(:instance) { FuseClient::FinQLFeatures.new }

  describe 'test an instance of FinQLFeatures' do
    it 'should create an instance of FinQLFeatures' do
      expect(instance).to be_instance_of(FuseClient::FinQLFeatures)
    end
  end
  ...
  describe 'test attribute "inferred"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
