...
# Unit tests for FuseClient::AssetReportTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FuseClient::AssetReportTransaction do
  let(:instance) { FuseClient::AssetReportTransaction.new }

  describe 'test an instance of AssetReportTransaction' do
    it 'should create an instance of AssetReportTransaction' do
      expect(instance).to be_instance_of(FuseClient::AssetReportTransaction)
    end
  end
