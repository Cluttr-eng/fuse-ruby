...
require 'fuse_client/models/financial_connections_investment_security_currency'
...
require 'fuse_client/models/financial_connections_investment_transaction_data_inner_currency'
