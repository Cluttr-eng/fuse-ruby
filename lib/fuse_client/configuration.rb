        ...
        'fuseApiKey' =>
          {
            ...
            in: 'header',
            key: 'Fuse-Api-Key',
            value: api_key_with_prefix('fuseApiKey')
          },
        'fuseClientId' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Fuse-Client-Id',
            value: api_key_with_prefix('fuseClientId')
          },
        'plaidClientId' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Plaid-Client-Id',
            value: api_key_with_prefix('plaidClientId')
          },
        'plaidSecret' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Plaid-Secret',
            value: api_key_with_prefix('plaidSecret')
          },
        'tellerApplicationId' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('tellerApplicationId')
          },
        'tellerCertificate' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('tellerCertificate')
          },
        'tellerPrivateKey' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('tellerPrivateKey')
          },
        'tellerTokenSigningKey' =>
          {
            ...
            value: api_key_with_prefix('tellerTokenSigningKey')
          },
        'tellerSigningSecret' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('tellerSigningSecret')
          },
        'mxClientId' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Mx-Client-Id',
            value: api_key_with_prefix('mxClientId')
          },
        'mxApiKey' =>
          {
            type: 'api_key',
        ...
        'monoPublicKey' =>
          {
            ...
            in: 'header',
            key: 'Mono-Public-Key',
            value: api_key_with_prefix('monoPublicKey')
          },
        'monoSecretKey' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Mono-Secret-Key',
            value: api_key_with_prefix('monoSecretKey')
          },
        'monoWebhookSecret' =>
          {
            type: 'api_key',
        ...
        'basiqApiKey' =>
          {
            ...
            in: 'header',
            key: 'Basiq-Api-Key',
            value: api_key_with_prefix('basiqApiKey')
          },
        'akoyaClientId' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Akoya-Client-Id',
            value: api_key_with_prefix('akoyaClientId')
          },
        'akoyaClientSecret' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('akoyaClientSecret')
          },
        'saltEdgeAppId' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'SaltEdge-App-Id',
            value: api_key_with_prefix('saltEdgeAppId')
          },
        'saltEdgeAppSecret' =>
          {
            type: 'api_key',
            ...
            value: api_key_with_prefix('saltEdgeAppSecret')
          },
      }
    end
