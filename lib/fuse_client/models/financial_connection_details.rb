...
module FuseClient
  class FinancialConnectionDetails
    ...
    attr_accessor :saltedge

    attr_accessor :sophtron
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'akoya')
        self.akoya = attributes[:'akoya']
      end

      if attributes.key?(:'saltedge')
        self.saltedge = attributes[:'saltedge']
      end

      if attributes.key?(:'sophtron')
        self.sophtron = attributes[:'sophtron']
      end
    end
    ...
    def hash
      [id, connection_status, connection_status_updated_at, is_oauth, aggregator, plaid, teller, mx, snaptrade, flinks, mono, truelayer, finverse, basiq, belvo, finicity, akoya, saltedge, sophtron].hash
    end
