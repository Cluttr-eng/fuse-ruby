...
module FuseClient
  class MigrateFinancialConnectionsTokenRequest
    ...
    def valid?
      ...
      aggregator_validator = EnumAttributeValidator.new('String', ["plaid", "mx", "teller"])
    ...
    def aggregator=(aggregator)
      validator = EnumAttributeValidator.new('String', ["plaid", "mx", "teller"])
