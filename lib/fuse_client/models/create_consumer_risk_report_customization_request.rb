...
module FuseClient
  class CreateConsumerRiskReportCustomizationRequest
    ...
    def list_invalid_properties
      ...
      if @risk_tolerance.nil?
        invalid_properties.push('invalid value for "risk_tolerance", risk_tolerance cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @risk_tolerance.nil?
      return false if @risk_tolerance > 100
      return false if @risk_tolerance < 1
      true
    end
    ...
    def risk_tolerance=(risk_tolerance)
      if risk_tolerance.nil?
        fail ArgumentError, 'risk_tolerance cannot be nil'
      end
