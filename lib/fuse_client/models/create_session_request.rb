  ...
  class CreateSessionRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'supported_financial_institution_aggregators')
        ...
        self.supported_financial_institution_aggregators = nil
      end
    ...
    def list_invalid_properties
      ...
      if @supported_financial_institution_aggregators.nil?
        invalid_properties.push('invalid value for "supported_financial_institution_aggregators", supported_financial_institution_aggregators cannot be nil.')
      end

      if @supported_financial_institution_aggregators.length < 1
    ...
    def valid?
      ...
      return false if @supported_financial_institution_aggregators.nil?
      return false if @supported_financial_institution_aggregators.length < 1
    ...
    def supported_financial_institution_aggregators=(supported_financial_institution_aggregators)
      if supported_financial_institution_aggregators.nil?
        fail ArgumentError, 'supported_financial_institution_aggregators cannot be nil'
      end
