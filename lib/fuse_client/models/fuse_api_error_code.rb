...
module FuseClient
  class FuseApiErrorCode
    ...
    MISSING_AKOYA_CLIENT_ID_HEADER = "missing_akoya_client_id_header".freeze
    MISSING_AKOYA_CLIENT_SECRET_HEADER = "missing_akoya_client_secret_header".freeze
    MISSING_SALTEDGE_APP_ID_HEADER = "missing_saltedge_app_id_header".freeze
    MISSING_SALTEDGE_APP_SECRET_HEADER = "missing_saltedge_app_secret_header".freeze
    MISSING_SOPHTRON_USER_ID_HEADER = "missing_sophtron_user_id_header".freeze
    MISSING_SOPHTRON_ACCESS_KEY_HEADER = "missing_sophtron_access_key_header".freeze
