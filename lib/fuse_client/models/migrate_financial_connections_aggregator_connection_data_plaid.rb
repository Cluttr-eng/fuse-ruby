...
module FuseClient
  ...
  class MigrateFinancialConnectionsAggregatorConnectionDataPlaid
    ...
    attr_accessor :use_item_webhook
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'use_item_webhook')
        self.use_item_webhook = attributes[:'use_item_webhook']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          use_item_webhook == o.use_item_webhook
    end
    ...
    def hash
      [access_token, use_item_webhook].hash
    end
