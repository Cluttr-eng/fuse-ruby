...
module FuseClient
  class EvalConsumerRiskReportRequest
    ...
    def list_invalid_properties
      ...
      if @window_size.nil?
        invalid_properties.push('invalid value for "window_size", window_size cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @window_size.nil?
    ...
    def hash
      [window_size, time_frame, events].hash
    end
