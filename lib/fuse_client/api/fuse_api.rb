...
module FuseClient
  class FuseApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [GetRecommendedFinancialInstitutionsRequest] :get_recommended_financial_institutions_request 
    # @return [GetRecommendedFinancialInstitutionsResponse]
    def get_recommended_financial_institutions(opts = {})
      data, _status_code, _headers = get_recommended_financial_institutions_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [GetRecommendedFinancialInstitutionsRequest] :get_recommended_financial_institutions_request 
    # @return [Array<(GetRecommendedFinancialInstitutionsResponse, Integer, Hash)>] GetRecommendedFinancialInstitutionsResponse data, response status code and response headers
    def get_recommended_financial_institutions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FuseApi.get_recommended_financial_institutions ...'
      end
      # resource path
      local_var_path = '/v1/financial_connections/institutions/recommended'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'get_recommended_financial_institutions_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'GetRecommendedFinancialInstitutionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['fuseApiKey', 'fuseClientId']

      new_options = opts.merge(
        :operation => :"FuseApi.get_recommended_financial_institutions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FuseApi#get_recommended_financial_institutions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SearchFinancialInstitutionsRequest] :search_financial_institutions_request 
    # @return [SearchFinancialInstitutionsResponse]
    def search_financial_institutions(opts = {})
      data, _status_code, _headers = search_financial_institutions_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SearchFinancialInstitutionsRequest] :search_financial_institutions_request 
    # @return [Array<(SearchFinancialInstitutionsResponse, Integer, Hash)>] SearchFinancialInstitutionsResponse data, response status code and response headers
    def search_financial_institutions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FuseApi.search_financial_institutions ...'
      end
      # resource path
      local_var_path = '/v1/financial_connections/institutions/search'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'search_financial_institutions_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'SearchFinancialInstitutionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['fuseApiKey', 'fuseClientId']

      new_options = opts.merge(
        :operation => :"FuseApi.search_financial_institutions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FuseApi#search_financial_institutions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SelectFinancialInstitutionsRequest] :select_financial_institutions_request 
    # @return [SelectFinancialInstitutionsResponse]
    def select_financial_institutions(opts = {})
      data, _status_code, _headers = select_financial_institutions_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SelectFinancialInstitutionsRequest] :select_financial_institutions_request 
    # @return [Array<(SelectFinancialInstitutionsResponse, Integer, Hash)>] SelectFinancialInstitutionsResponse data, response status code and response headers
    def select_financial_institutions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FuseApi.select_financial_institutions ...'
      end
      # resource path
      local_var_path = '/v1/financial_connections/institutions/select'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'select_financial_institutions_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'SelectFinancialInstitutionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['fuseApiKey', 'fuseClientId']

      new_options = opts.merge(
        :operation => :"FuseApi.select_financial_institutions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FuseApi#select_financial_institutions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
